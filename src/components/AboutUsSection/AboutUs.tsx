          ...
          <div className='text-lg lg:text-2xl text-left text-zinc-400'>
            ...
            {isExpanded && (
              <>
                ...
                sempre entregando conteúdos que valorizam cada marca e cada
                momento.
                <br />
                <br />
                Com base em Brasília e o coração no Brasil inteiro, a{' '}
                <span className='font-bold text-white'>Cerrado61</span> é
                parceira de quem entende que imagem e narrativa caminham juntas
                — seja para um evento corporativo, uma ação cultural ou uma
                campanha digital.
                <br />
                <br />
